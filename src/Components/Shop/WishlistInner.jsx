            ...
            <div className="container">
                <div className="tinv-wishlist woocommerce tinv-wishlist-clear">
                                ...
                                {wishlistItems.map((item) => (
                                    <tr key={item.id} className="wishlist_item">
                                        ...
                                        <td className="product-action">
                                            <Link href="/cart" className="button th-btn" title="Add to Cart">
                    ...
                    <div className="social-buttons">
                        ...
                        <ul>
                            <li>
                                <a href="https://www.facebook.com/sharer/sharer.php?u=permalink" className="social social-facebook" aria-label="Share on Facebook" target="_blank" rel="noopener noreferrer">
                                    <i className="fab fa-facebook-f" />
                                </a>
                            </li>
                            <li>
                                <a href="https://twitter.com/share?url=permalink" className="social social-twitter" aria-label="Share on Twitter" target="_blank" rel="noopener noreferrer">
                                    <i className="fab fa-twitter" />
                                </a>
                            </li>
                            <li>
                                <a href="http://pinterest.com/pin/create/button/?url=permalink" className="social social-pinterest" aria-label="Share on Pinterest" target="_blank" rel="noopener noreferrer">
                                    <i className="fab fa-pinterest-p" />
                                </a>
                            </li>
                            <li>
                                <a href="https://api.whatsapp.com/send?text=permalink" className="social social-whatsapp" aria-label="Share on WhatsApp" target="_blank" rel="noopener noreferrer">
                                    <i className="fab fa-whatsapp" />
                                </a>
                            </li>
                            <li>
                                <a href="mailto:?body=permalink" className="social social-email" aria-label="Share via Email">
