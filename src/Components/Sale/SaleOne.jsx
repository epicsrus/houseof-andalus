...
function SaleOne() {
    return (
        <section
            ...
            id="service-sec"
            style={{ backgroundImage: "url('/assets/img/bg/shape_bg_1.png')" }}
        >
                ...
                <div className="slider-area tour-slider">
                    ...
                    >
                        <SwiperSlide>
                            <div className="tour-box style2 th-ani gsap-cursor">
                                <div className="tour-box_img global-img">
                                    <img src="/assets/img/tour/tour-1_1.jpg" alt="" />
                                </div>
                                <div className="tour-content">
                                    <h3 className="box-title">
                                        <Link href="/tour-details">Aquavita Boat</Link>
                                    </h3>
                        ...
                        <SwiperSlide>
                            <div className="tour-box style2 th-ani gsap-cursor">
                                <div className="tour-box_img global-img">
                                    <img src="/assets/img/tour/tour-1_2.jpg" alt="" />
                                </div>
                                <div className="tour-content">
                                    <h3 className="box-title">
                                        <Link href="/tour-details">Golden Odyssey</Link>
                                    </h3>
                                    <div className="tour-rating">
                                        <div
                                            className="star-rating"
                        ...
                        <SwiperSlide>
                            <div className="tour-box style2 th-ani gsap-cursor">
                                <div className="tour-box_img global-img">
                                    <img src="/assets/img/tour/tour-1_3.jpg" alt="" />
                                </div>
                                <div className="tour-content">
                                    <h3 className="box-title">
                                        <Link href="/tour-details">Luxury Motor Yacht</Link>
                                    </h3>
                                    <div className="tour-rating">
                                        <div
                                            className="star-rating"
